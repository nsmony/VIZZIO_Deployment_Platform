...
export default function TopNavbar({ title, onMenuToggle, sidebarOpen = true, username = 'Admin', profileImage = '', initials = 'A', onProfileClick, profileOpen, children }) {
  ...
  return (
    <header className="top-navbar">
      ...
      <div className="top-navbar-right">
        ...
        <button
          className={`top-icon-button ${location.pathname === '/settings' ? 'active' : ''}`}
          type="button"
